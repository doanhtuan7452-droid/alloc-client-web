    ...
    return (
        <div className="bg-white/5 backdrop-blur-md border border-white/10 p-10 rounded-2xl shadow-2xl w-full max-w-[380px] text-center text-white mx-4 transition-all duration-300 hover:border-white/20">
            ...
            <div className="flex flex-col gap-4">
                ...
                <button
                    className="flex items-center justify-center py-3 px-5 text-base font-medium bg-white text-[#191a1f] rounded-xl transition-all duration-200 hover:bg-gray-100 shadow-lg active:scale-[0.98]"
