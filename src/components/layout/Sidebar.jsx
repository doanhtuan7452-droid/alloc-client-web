    ...
    <aside className="w-64 bg-[#111827] border-r border-[#1f2937] h-screen flex flex-col justify-between fixed">
      <div>
        ...
        <nav className="mt-4 px-4 flex flex-col gap-1">
          <NavLink to="/" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive ? 'bg-[#1f2937] text-white' : 'text-slate-400 hover:text-white hover:bg-[#1f2937]'}`}>
            <Home className="w-4 h-4" /> Home
          </NavLink>
          <NavLink to="/workspaces" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive ? 'bg-[#1f2937] text-white' : 'text-slate-400 hover:text-white hover:bg-[#1f2937]'}`}>
          ...
          <NavLink to="/members" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive ? 'bg-[#1f2937] text-white' : 'text-slate-400 hover:text-white hover:bg-[#1f2937]'}`}>
            <Users className="w-4 h-4" /> Members
          </NavLink>
          <NavLink to="/conversations" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive ? 'bg-[#1f2937] text-white' : 'text-slate-400 hover:text-white hover:bg-[#1f2937]'}`}>
