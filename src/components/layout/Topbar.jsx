...
export default function Topbar() {
  return (
    <header className="h-16 border-b border-neutral-800 flex items-center justify-between px-8 bg-black">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-8 h-8 rounded-full bg-slate-700 overflow-hidden border-2 border-neutral-800">
