...
const Register = () => {
    ...
    const handleRegister = (e) => {
        e.preventDefault();
        console.log("Tiến hành đăng ký với:", { fullName, email, password, confirmPassword });
        // Chuyển hướng nều cần, ví dụ OTP hoặc Login
    };
    ...
    return (
        <div className="bg-white/5 backdrop-blur-md border border-white/10 p-10 rounded-2xl shadow-2xl w-full max-w-[420px] text-white mx-4 transition-all duration-300 hover:border-white/20">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-gray-400 text-sm">Tạo tài khoản Alloc cho Workspace của bạn</p>
            </div>
            ...
            <div className="mt-6 text-center text-sm text-gray-400">
                Đã có tài khoản?{' '}
                <button 
                  onClick={() => navigate('/login-test/email')} 
