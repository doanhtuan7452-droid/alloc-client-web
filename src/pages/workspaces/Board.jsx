    ...
    <div className="max-w-7xl mx-auto h-full flex flex-col">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 border border-border-default rounded-md bg-header hover:bg-neutral-800 text-sm text-neutral-300 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start flex-1 overflow-hidden">
        ...
        <BoardColumn title="Review" count={1}>
          <TaskCard 
            opacity={75}
            tags={[
              { label: "PROOFING", bgClass: "bg-neutral-800", textClass: "text-neutral-300", borderClass: "border-border-subtle" }
            ]}
