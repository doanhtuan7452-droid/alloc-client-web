  ...
  return (
    <div className="max-w-6xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        {/* Core Team */}
        <div className="col-span-2 bg-surface border border-border-default rounded-xl p-6">
          ...
          <div className="space-y-4">
            {/* Member */}
            <div className="flex items-center justify-between p-3 hover:bg-surface-hover/50 rounded-lg transition-colors border border-transparent hover:border-border-default">
            ...
            <div className="flex items-center justify-between p-3 hover:bg-surface-hover/50 rounded-lg transition-colors border border-transparent hover:border-border-default">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-medium text-content-primary">Dr. Alyx Vance</h4>
              ...
              <div className="flex gap-2">
                ...
                <span className="bg-element text-content-secondary border border-border-default text-[10px] px-2 py-1 rounded font-mono">
                  Python
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 hover:bg-surface-hover/50 rounded-lg transition-colors border border-transparent hover:border-border-default">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-element flex items-center justify-center text-content-muted text-sm border-2 border-border-default">
                  IK
                </div>
                <div>
                  <h4 className="font-medium text-content-primary">Isaac Kleiner</h4>
              ...
              <div className="flex gap-2">
                <span className="bg-element text-content-muted border border-border-default text-[10px] px-2 py-1 rounded font-mono">
                  Anomalous Materials
                </span>
              </div>
            </div>
        ...
        {/* Leave Inbox */}
        <div className="bg-surface border border-border-default rounded-xl p-6 flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-4 flex-1 overflow-y-auto pr-2">
            {/* Request 1 */}
            <div className="bg-inset border border-border-default p-3 rounded-lg">
              ...
              <p className="text-xs text-content-muted font-mono mb-3">
                Oct 12 - Oct 14
              </p>
              <div className="flex gap-2">
                <button className="flex-1 py-1.5 text-xs border border-border-default rounded bg-surface text-content-muted hover:text-white hover:bg-surface-hover">
                  Deny
                </button>
            ...
            <div className="bg-inset border border-border-default p-3 rounded-lg">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] font-mono text-content-muted bg-element px-1.5 rounded">
                  PTO
                </span>
              </div>
              <p className="text-xs text-content-muted font-mono mb-3">
      ...
      <div className="bg-surface border border-border-default rounded-xl p-6">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            {/* High Prob */}
            <div className="bg-element/50 rounded-lg p-6 flex flex-col items-center justify-center border border-transparent hover:border-border-default transition-colors h-32">
              <span className="text-4xl font-bold font-mono text-purple-300">
                2
              </span>
              <span className="text-xs text-content-muted font-mono mt-2">
                Med Risk
              </span>
            </div>
            ...
            <div className="bg-element/50 rounded-lg p-6 flex flex-col items-center justify-center border border-transparent hover:border-border-default transition-colors h-32">
              <span className="text-4xl font-bold font-mono text-content-secondary">
                2
              </span>
              <span className="text-xs text-content-muted font-mono mt-2">
                High Risk
            ...
            {/* Low Prob */}
            <div className="bg-inset border border-border-default rounded-lg p-6 flex flex-col items-center justify-center opacity-50 h-32">
